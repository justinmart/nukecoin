...
const string strMessageMagic = "NukeCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.1 * 24 * 60 * 60; // NukeCoin: 0.1 days
static const int64 nTargetSpacing = 60; // NukeCoin: 60 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal nukecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NukeCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2b664a1ce1b6944f51eb9a1de2c285b7475bd7ddf0658e501a58c660e7df6022");
    }
	...
	//  nTime=1390863102, nBits=1e0ffff0, nNonce=2085386442, vtx=1)
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Today's headline: Charlie Shrem arrested on charges of money laundering";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x6d24a735408e4f701677968555de609c144e0ddd3fa16a7ec8cfbad95f82edb6"));
